...
/**
 * A non-persistent event store, enough to stand up a real relay for the round-trip
 * smoke test without a database.
 */
final class InMemoryRelayEventStore implements RelayEventStoreInterface
{
